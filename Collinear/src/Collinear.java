...
class Collinear
{
   ...
   // ----------------------------------------------------------
     ...
     *  Order of growth: N^3
     *
     *  Explanation: It contains 3 linear for-loops
     */
    static int countCollinear(int[] a1, int[] a2, int[] a3)
    {
    	...
    	for (int i1=0; i1 < a1.length; i1++)
    	{
    		for (int i2=0; i2 < a2.length; i2++)
    		{
    			...
    			{
    				if ((a1[i1]*(y2 - y3) + a2[i2]*(y3 - y1) + a3[i3]*(y1 - y2)) == 0)
    				{
    				  count++;
    				}
    			}
     ...
     *  You should adequately explain your answer. Answers without adequate explanation will not be counted.
     *
     *  Order of Growth: N^2log(N)
     *
     *  Explanation: It contains 2 linear for-loops with Order of Growth N^2 and uses the binary search method with Order of Growth log(N)
     *
     *
     */
    static int countCollinearFast(int[] a1, int[] a2, int[] a3)
    {
        ...
        for(int i = 0; i < a1.length; i++)
        {
        	...
        	{
        		int testNumber = a1[i]*(y2-y3) + a2[j]*(y3-y1);
        		int binarySearchNumber = (-1 * (testNumber/(y1-y2)));
        		if(Collinear.binarySearch(a3, binarySearchNumber))
        		{
        			count++;
        		}
        	}
     ...
     *  Order of Growth: N^2
     *
     *  Explanation: It contains two linear for-loops.
     *
     */
     ...
     *
     *  Explanation: For N elements of binary search, n*(1/2)^k = 1. Therefore n = 2^k, and hence, k = log(N)
     *  
     *  
     *
     */
